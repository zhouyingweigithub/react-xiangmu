...
class Log extends React.Component {
  ...
  denglu() {
    ...
    if (zhanghao.value == this.xinxi.zhanghao && mima.value == this.xinxi.mima) {
              ...
              >
                <ul>
                  <li className={style.Log}>
                    <a href="javascript:;" className={style.serserLog}>
                      登录
                    </a>
                  </li>
                  <li className={style.Log}>
          ...
          <div>
            <div style={{ marginBottom: "10px" }}>
              ...
              <span>
                <input
                  id="zhanghao"
                  style={{ marginLeft: "10px", height: "25px", width: "250px" }}
                  type="text"
                  placeholder="请输入登录名"
                />
              </span>
